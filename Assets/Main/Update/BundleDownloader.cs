...
{
	 #region singleton
	private static BundleDownloader _instance = null;
	public static BundleDownloader Singleton
	{
		get
		{
			if (_instance == null)
			{
				_instance = new GameObject("[BundleDownloader]").AddComponent<BundleDownloader>();
			}
			return _instance;
		}
	}
