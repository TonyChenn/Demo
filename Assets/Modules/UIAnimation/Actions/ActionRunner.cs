...
namespace UIAnimation.Actions
{
    ...
    public class ActionRunner : MonoBehaviour
    {
        ...
        [SerializeField] private ActionEntryContainer entryContainer = new ActionEntryContainer();
        [SerializeField] private bool fastforwardOnDisable = false;
        ...
        {
            get { return entryContainer; }
            set { entryContainer = value; }
        }

        public bool FastforwardOnDisable
        {
            get { return fastforwardOnDisable; }
            set { fastforwardOnDisable = value; }
        }
