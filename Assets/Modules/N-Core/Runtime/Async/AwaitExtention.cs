...
namespace NCore
{
    ...
    {
        #region GetAwaiter Extention Methods
        ...
        // await new WaitForSecondsRealtime()
        ...
        [Obsolete("WWW 已过时，使用UnityWebRequest")]
        ...
        class CoroutineWrapper<T>
        {
            ...
            static List<Type> GenerateObjectTrace(IEnumerable<IEnumerator> enumerators)
            {
                ...
                foreach (var enumerator in enumerators)
                {
                    ...
                    var field = enumerator.GetType().GetField("$this",
