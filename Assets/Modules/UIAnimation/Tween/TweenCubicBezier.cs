...
namespace UIAnimation.Tween
{
    ...
    public class TweenCubicBezier : TweenActionBase
    {
        ...
        [SerializeField]
        private Vector3 controlPosition1;
        public Vector3 ControlPosition1
        {
            get
            {
                return controlPosition1;
            }
            set
            {
                controlPosition1 = value;
            }
        }

        [SerializeField]
        private Vector3 controlPosition2;
        public Vector3 ControlPosition2
        {
            get
            {
                return controlPosition2;
            }
            set
            {
                controlPosition2 = value;
            }
        }
